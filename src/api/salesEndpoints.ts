export const SALES_ENDPOINTS = {
  ...
  GOODS_RECEIVED_NOTES: {
    GET_ALL: "/sales/grn",
    GET_BY_ID: (id: string) => `/sales/grn/${id}`,
    ADD: "/sales/grn/create",
    UPDATE: (id: string) => `/sales/grn/${id}/update`,
    DELETE: (id: string) => `/sales/grn/${id}/delete`,
  },
  INVOICES: {
    GET_ALL: "/sales/invoices",
    GET_BY_ID: (id: string) => `/sales/invoices/${id}`,
    ADD: "/sales/invoices/create",
    UPDATE: (id: string) => `/sales/invoices/${id}/update`,
    DELETE: (id: string) => `/sales/invoices/${id}/delete`,
    SEND: (id: string) => `/sales/invoices/${id}/send`,
    PAY: (id: string) => `/sales/invoices/${id}/pay`,
    CANCEL: (id: string) => `/sales/invoices/${id}/cancel`,
  },
  LETTER_OF_CREDIT: {},
};
