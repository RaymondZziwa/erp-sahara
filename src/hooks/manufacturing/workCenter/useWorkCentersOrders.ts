...
import {
  ...
  fetchDataSuccess,
  fetchDataFailure,
} from "../../../redux/slices/manufacturing/workCenters/workCenterOrdersSlice.ts"; // Import actions from your data reducer
...
import { WorkOrder } from "../../../redux/slices/types/manufacturing/WorkOrder.ts";

const useWorkCenterOrders = () => {
  ...
  const data = useAppSelector((state) => state.workCenterOrders);

  return { ...data, refresh: fetchDataFromApi };
};

export default useWorkCenterOrders;
