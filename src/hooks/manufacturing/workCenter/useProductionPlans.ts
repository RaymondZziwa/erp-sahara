...
import {
  ...
  fetchDataSuccess,
  fetchDataFailure,
} from "../../../redux/slices/manufacturing/workCenters/productionPlansSlice.ts"; // Import actions from your data reducer
...
const useProductionPlans = () => {
  ...
  const data = useAppSelector((state) => state.productionPlans);
