...
import {
  ...
  fetchDataSuccess,
  fetchDataFailure,
} from "../../redux/slices/assets/assetsSlice"; // Import actions from your assets reducer
...
const useAssets = () => {
  ...
  const fetchDataFromApi = async () => {
    ...
    try {
      const response = await apiRequest<ServerResponse<Asset[]>>(
        ASSETSENDPOINTS.ASSETS.GET_ALL, 
        "GET",
        token.access_token
      );
