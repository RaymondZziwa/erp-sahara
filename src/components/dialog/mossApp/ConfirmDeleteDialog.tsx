...
const ConfirmMossDeleteDialog: React.FC<ConfirmDeleteDialogProps> = ({
  visible,
  apiPath,
  onClose,
  onConfirm,
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      const data = await mossAppApiRequest<ServerResponse<unknown>>(
        apiPath,
        "DELETE",
        token.access_token
      );
...
export default ConfirmMossDeleteDialog;
