...
import useInvoiceSequence from "../../../../hooks/recruitment/useInvoiceSequence";

const InvoiceSequences: React.FC = () => {
  const { data: invoiceSequences, refresh } = useInvoiceSequence();
  ...
  return (
    <div>
      ...
      <BreadCrump name="Invoice Sequences" pageName="Invoice Sequences" />
      <div className="bg-white px-8 rounded-lg">
        <div className="flex justify-between items-center mb-4">
          <div className="py-2">
            <h1 className="text-xl font-bold">Invoice Sequences</h1>
          </div>
        ...
        <Table columnDefs={columnDefinitions} data={invoiceSequences || []} ref={tableRef} />
      </div>
    </div>
  );
};

export default InvoiceSequences;
