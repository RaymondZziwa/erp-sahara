...
const AppointmentTypes: React.FC = () => {
  const { data, refresh } = useAppointmentTypes();
  const tableRef = useRef<any>(null);

  const [dialogState, setDialogState] = useState<{
    selectedItem: AppointmentType | undefined;
  ...
  const columnDefinitions: ColDef<AppointmentType>[] = [
    {
      headerName: "ID",
      field: "id",
      sortable: true,
...

    {
      ...
      sortable: false,
      filter: false,
      cellRenderer: (params: ICellRendererParams<AppointmentType>) => (
  ...
  return (
    <div>
      ...
      <ConfirmDeleteDialog
        ...
        onConfirm={refresh}
      />
      <BreadCrump name="AppointmentTypes" pageName="All" />
      <div className="bg-white px-8 rounded-lg">
        <div className="flex justify-between items-center">
          <div className="py-2">
            <h1 className="text-xl font-bold">AppointmentTypes Table</h1>
          </div>
