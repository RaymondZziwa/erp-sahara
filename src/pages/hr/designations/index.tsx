...
const Designations: React.FC = () => {
  const { data, refresh } = useDesignations();
  const tableRef = useRef<any>(null);

  const [dialogState, setDialogState] = useState<{
    selectedItem: Designation | undefined;
    currentAction: "delete" | "edit" | "add" | "";
  }>({ selectedItem: undefined, currentAction: "" });


  const columnDefinitions: ColDef<Designation>[] = [
    {
      headerName: "Name",
    ...
    },
    {
      ...
      field: "designation_name", // this can remain if it's needed for sorting/filtering
      sortable: true,
      filter: true,
      cellRenderer: (params) => {
  ...
  return (
    <div>
      ...
      {dialogState.selectedItem && (
        <ConfirmDeleteDialog
          apiPath={HUMAN_RESOURCE_ENDPOINTS.DESIGNATIONS.DELETE(
      ...
      <BreadCrump name="Designations" pageName="All" />
