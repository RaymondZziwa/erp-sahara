...
const LeaveTypes: React.FC = () => {
  const { data, refresh } = useLeaveTypes();
  const tableRef = useRef<any>(null);

  const [dialogState, setDialogState] = useState<{
    selectedItem: LeaveType | undefined;
  ...
  const columnDefinitions: ColDef<LeaveType>[] = [
    ...
    },
    {
      ...
      sortable: false,
      filter: false,
      cellRenderer: (params: ICellRendererParams<LeaveType>) => (
  ...
  return (
    <div>
      ...
      {dialogState.selectedItem && (
        <ConfirmDeleteDialog
          apiPath={HUMAN_RESOURCE_ENDPOINTS.LEAVE_TYPES.DELETE(
      ...
      <BreadCrump name="Leave types" pageName="All" />
